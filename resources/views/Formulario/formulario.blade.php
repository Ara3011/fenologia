...
<div>
            ...
            <select class="form-control" v-model="id_estado">
                ...
                <input type="text" v-model="id_estado" >
            </select>
    </div>
            ...
            <div class="form-group">
                ...
                <select class="form-control" v-model="id_frutal">
                    ...
                    <input type="text" v-model="id_frutal" >
                </select>
            </div>
            <div class="box">
    ...
    <script>
        new Vue({
            ...
            data: {
                ...
                apifrutal: "{{url("api/frutal")}}",
                apiestado: "{{url("api/estados")}}",
                semanal: [],
                nombreSemanal: "",
                correoSemanal: "",
                rancheriaSemanal: "",
            ...
            methods: {
                ...
                getFrutales: function () {
                    axios.get(this.apifrutal).then(response => {
                        this.frutales = response.data;
                    });
                },
                getEstados: function () {
                    axios.get(this.apiestado).then(response => {
